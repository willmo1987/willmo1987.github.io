...
&emsp;&emsp;**本博客为个人原创，转载需在明显位置注明出处：http://willclub.me/toolbar/**
...
在说具体使用之前，要提醒大家首先配置theme，将ActionBar禁掉，因为我们已经有了ToolBar。另外targetSdkVersion需要配置为21+，因为前几天刚更新到了22，所以我配的是22。下面是theme的具体配置：
